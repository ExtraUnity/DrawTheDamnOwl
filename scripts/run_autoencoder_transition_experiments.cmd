...
echo ============================================================
%PYTHON_CMD% experiments\train_autoencoder_transition.py %COMMON_ARGS% --latent_channels 64 --lambda_image 1.0 --output_dir %OUTPUT_ROOT%\autoencoder_transition_baseline
